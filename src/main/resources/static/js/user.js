...
$(function () {
    ...
    $(".loginBtn").on("click", function () {
        ...
        if (!emailPattern.test(email)) {
            $("#emailError").text("올바른 이메일을 입력하세요.").addClass("text-danger").removeClass("text-success");
            loginCheck = false;
        } else {
            $("#emailError").text("✅").addClass("text-success").removeClass("text-danger");
        }
        ...
        if (!passwordPattern.test(password)) {
            ...
            $("#passwordError").text("✅").addClass("text-success").removeClass("text-danger");
        }
